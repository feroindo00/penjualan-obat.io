...
$pdf->SetX(25);
$sukaes='Sukses';
$sql=mysqli_query($con,"SELECT kartu_stock.* FROM kartu_stock where tanggal and tanggal BETWEEN '$tanggal_awal' and '$tanggal_akhir' and kd_obat='$id'order by tanggal")or die(mysqli_error());
