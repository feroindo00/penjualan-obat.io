<div class="container-fluid">
	...
	<meta http-equiv="refresh" content="1; url='index?p=proses_pasien'">
	<?php	
		} 
	?>
	<hr>
	...
	<div class="row">
		...
		<div class="col-md-4">
			<?php
				if(isset($_POST['proses'])){
					...
					$tanggal = date('y-m-d');
					$qa=mysql_query("INSERT INTO detil_transaksi(id_transaksi,kd_obat,jumlah,harga,id_jual) SELECT id_keranjang,kd_obat,jumlah,harga,'$codeotomatic' FROM keranjang");
		...
		<div class="col-md-4">
			<br><br>
			<a href="index?p=selesai" class="btn-success">
				Enter
			</a>&nbsp;
			<a href="index?p=cetak_nota&id=<?php echo $codeotomatic;?>" class="btn btn-success"><spann class="fa fa-print"></spann></a>
		</div>
	</div><br><br>
	<?php
	} 
