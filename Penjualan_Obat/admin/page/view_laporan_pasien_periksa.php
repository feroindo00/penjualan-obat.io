        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			  ...
			  <?php
				$no = 1;				
				$queryy = "select *, count(id_p_pks) as jumlah_pks from tb_pemeriksaan, tb_pasien where tb_pemeriksaan.id_p_pks=tb_pasien.id_p and status_pks=0 order by jumlah_pks desc";
				
				if(isset($_POST['cari_tanggal'])){
				$tanggal_awal=$_POST['tanggal_awal'];
				$tanggal_akhir=$_POST['tanggal_akhir'];
				$queryy = "select *, count(id_p_pks) as jumlah_pks from tb_pemeriksaan, tb_pasien where tb_pemeriksaan.id_p_pks=tb_pasien.id_p and status_pks=0 and tanggal_input_p NOT IN (0000-00-00) and tanggal_input_p between '$tanggal_awal' and '$tanggal_akhir' order by jumlah_pks desc";
				}
