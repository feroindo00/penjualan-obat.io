    ...
    function Header()
{
    ...
    $this->Ln(5);
    $this->Cell(190,15,'LAPORAN PENJUALAN PERIODE OBAT RESEP',0,0,'C');
    $this->Ln(5);
...
$pdf->SetX(5);
$sukaes='Sukses';
$sql=mysqli_query($con,"SELECT detil_transaksi_resep.*,resep_obat.*,transaksi_jual_resep.* FROM detil_transaksi_resep INNER JOIN resep_obat ON resep_obat.id_resep_obat = detil_transaksi_resep.id_resep_obat INNER JOIN transaksi_jual_resep on transaksi_jual_resep.id_jual = detil_transaksi_resep.id_jual where tanggal and tanggal between '$tanggal_awal' and '$tanggal_akhir' order by tanggal desc");
