    ...
    function Header()
{
    ...
    $lol="SELECT detil_transaksi.*,obat.*,transaksi_jual.* FROM detil_transaksi INNER JOIN obat ON obat.kd_obat = detil_transaksi.kd_obat INNER JOIN transaksi_jual on transaksi_jual.id_jual = detil_transaksi.id_jual where id_transaksi = '1'";
    ...
    $this->Ln(5);
    $this->Cell(190,15,'LAPORAN PENJUALAN OBAT',0,0,'C');
    $this->Ln(5);
...
$pdf->SetX(5);
$sukaes='Sukses';
$sql=mysqli_query($con,"SELECT detil_transaksi.*,obat.*,transaksi_jual.* FROM detil_transaksi INNER JOIN obat ON obat.kd_obat = detil_transaksi.kd_obat INNER JOIN transaksi_jual on transaksi_jual.id_jual = detil_transaksi.id_jual ");
