<div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Laporan Data Obat Kadaluarsa</li>
      </ol>
   <?php
      $tanggal_sekarang = date('y-m-d');
      $flash="select * from obat where tanggal_kadaluarsa <='$tanggal_sekarang'";
    ...
    <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel Data Obat Kadaluarsa</div>
        <div class="card-body">
        ...
        $queryy = "SELECT * FROM obat, jenis_obat WHERE
                     obat.id_jenis_obat=jenis_obat.id_jenis_obat and tanggal_kadaluarsa  between '$tanggal_sekarang ' and tanggal_kadaluarsa order by tanggal_kadaluarsa asc ";
      ...
      <center><a href='index?p=unduh_laporan_obat_kadaluarsa' class="btn btn-sm btn-warning" style="width: 80%;">Unduh Laporan</a></center><br><br>
    </div>
    <!-- /.container-fluid-->