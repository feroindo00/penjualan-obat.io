        ...
        $klinik = $data['klinik'];
          ...
          <td><?php echo $jenis_pasien;?></td>
				 ...
				 <!-- <?php
				  ...
				  ?>!-->
          <!--<a href='index?p=proses_pasien&id_pasien=<?php echo $id_pasien;?>'class="btn btn-sm btn-warning">Proceed</a>!-->
          <td><center>
				  <a href='index?p=ubah_pasien&id=<?php echo $id_pasien;?>' class="btn btn-sm btn-success">Ubah</a><br><br>
