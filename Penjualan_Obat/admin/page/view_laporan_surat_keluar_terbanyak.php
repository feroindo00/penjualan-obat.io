	...
	<br><br>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel Data Laporan Surat Keluar Terbanyak</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			  ...
			  <?php
				$no = 1;				
				$queryy = "select *, count(penerima_sk) as jumlah_skt from tb_surat_keluar, tb_pengirim_penerima where tb_surat_keluar.penerima_sk=tb_pengirim_penerima.kode_pp group by penerima_sk order by jumlah_skt desc";
				
				if(isset($_POST['cari_tanggal'])){
				$tanggal_awal=$_POST['tanggal_awal'];
				$tanggal_akhir=$_POST['tanggal_akhir'];
				$queryy = "select *, count(penerima_sk) as jumlah_skt from tb_surat_keluar, tb_pengirim_penerima where tb_surat_keluar.penerima_sk=tb_pengirim_penerima.kode_pp and tanggal_input_sk NOT IN (0000-00-00) and tanggal_input_sk between '$tanggal_awal' and '$tanggal_akhir' group by penerima_sk order by jumlah_skt desc";
				}
	...
	<a href='laporan/unduh_laporan_surat_keluar_terbanyak' class="btn btn-sm btn-warning" style="width: 100%;">Unduh Laporan</a><br><br>   
	...
	<div class="modal fade" id="cari_tanggal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="index?p=view_laporan_surat_keluar_terbanyak" method="post" role="form">
