    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Data Laporan Obat Resep Per-Periode</li>
      </ol>
 <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#cari_tanggall" style='width: 100%; color: white;'>Cari Berdasarkan Tanggal</a>
    ...
    <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel Laporan Data Penjualan Obat Resep Per-Periode</div>
        <div class="card-body">
  ...
  <div class="modal fade" id="cari_tanggal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
          <form action="index?p=unduh_laporan_obat_resep_periode" method="post" role="form">
