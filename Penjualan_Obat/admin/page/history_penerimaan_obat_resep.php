<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="index?p=data_penerimaan_obat_resep">Penerimaan Obat Resep</a></li>
        <li class="breadcrumb-item active"><b>History Obat Resep</b></li>
    </ol>
    <?php
    		...
    		<div class="table-responsive">
    			<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    				...
    				<tbody>
    					<?php
    						$no = 1;
    						$query ="SELECT * FROM penerimaan_obat_resep order by id_penerimaan desc";
