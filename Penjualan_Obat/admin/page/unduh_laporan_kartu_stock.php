    ...
    function Header()
{
    ...
    $this->Ln(5);
    $this->Cell(190,15,'LAPORAN KARTU STOCK OBAT',0,0,'C');
    $this->Ln(5);
...
$sukaes='Sukses';
$id = $_GET['id'];
$sql=mysql_query("SELECT * FROM kartu_stock where tanggal and tanggal BETWEEN '$tanggal_awal' and '$tanggal_akhir' and kd_obat='$id'  order by tanggal");
...
$pdf->CELL(25,9,'Sisa Stok',1,0,'C',1);
...
$pdf->cell(25,9,$data['sisa_stok'],1,0,'C',1);
