<div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Laporan Data Stok Obat Resep</li>
      </ol>
      <!-- Example DataTables Card-->
    <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabel Data Stok Obat Resep</div>
        <div class="card-body">
        ...
        $queryy = "SELECT * FROM resep_obat, jenis_obat WHERE
                     resep_obat.id_jenis_obat=jenis_obat.id_jenis_obat and jumlah_obat<=10";
      ...
      <center><a href='index?p=unduh_laporan_obat_resep_stok' class="btn btn-sm btn-warning" style="width: 80%;">Unduh Laporan</a></center><br><br>
    </div>
    <!-- /.container-fluid-->