...
include "../ctrl/code.php";
	...
	if (empty($_SESSION['username_karyawan'])) 
	{
...
<body class="fixed-nav sticky-footer bg-primary" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-secondary bg-primary fixed-top" id="mainNav"style="color:white;">
    <a class="navbar-brand" style="color:white;" href="./">Penjualan Obat</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <center><h7>KLINIK PENGOBATAN PALEMBANG MAGETAN JAWA TIMUR</h7></center>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="karyawan">
          ...
          <ul class="sidenav-second-level collapse" id="collapsekaryawan">
            <li>
             ...
             <li>
              <a href="index?p=data_dokter" style="color:white;">
                <i class="fa fa-fw fa-circle-o"style="color:white;"></i>
                <span class="nav-link-text"style="color:white;">
                Dokter
                </span>
		 ...
		 <li class="nav-item" data-toggle="tooltip" data-placement="right" title="transaksi">
          ...
          <ul class="sidenav-third-level collapse" id="collapsetransaksi">
            <li>
             ...
             <li>
              <a href="index?p=data_transaksi_resep" style="color:white;">
                <i class="fa fa-fw fa-circle-o"style="color:white;"></i>
                <span class="nav-link-text"style="color:white;"> &nbsp; Transaksi Resep
              </a>
            </li>
    ...
    ?>
      ...
      <ul class="navbar-nav ml-auto">
		...
		<?php
			$cek_session = $_SESSION['username_karyawan'];				
			$queryy = "SELECT * FROM karyawan, jabatan WHERE
                     karyawan.id_level_karyawan=jabatan.id_jabatan_karyawan AND
                     username_karyawan='$cek_session'";
			$sqll = mysqli_query($con,$queryy) or die(mysqli_error());
      ...
      $level_jabatan_karyawan = $data['level_jabatan_karyawan'];
		?>
             <i class="fa fa-fw fa-user"style="color:white;"></i>
            <font style="color:white;">Hallo, <?php echo $nama_karyawan; ?> [<?php echo $level_jabatan_karyawan; ?>] </font>
        </li>
      </ul>
    </div>
  </nav>
