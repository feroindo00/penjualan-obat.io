   ...
   <img src="files/logo.png" />
        ...
        <form action="ctrl/proses_login" method="post" role="form">
          <div class="form-group">
            ...
            <input class="form-control" id="username_karyawan" name="username_karyawan" type="text" placeholder="Masukkan Username Disini ..." required>
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input class="form-control" id="password_karyawan" name="password_karyawan" type="password" placeholder="Masukkan Password Disini ..." required>
          </div>
